...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.fi/finnish-base-profiles/StructureDefinition/municipality-code']) &lt;= 1">extension with URL = 'http://fhir.fi/finnish-base-profiles/StructureDefinition/municipality-code': maximum cardinality of 'extension' is 1</sch:assert>
