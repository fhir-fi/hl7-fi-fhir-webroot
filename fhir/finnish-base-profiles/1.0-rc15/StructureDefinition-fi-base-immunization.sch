...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile IPAImmunization
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Immunization">
      <sch:assert test="count(f:extension[@url = 'https://hl7.fi/fhir/finnish-base-profiles/StructureDefinition/vaccination-recorder']) &lt;= 1">extension with URL = 'https://hl7.fi/fhir/finnish-base-profiles/StructureDefinition/vaccination-recorder': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Immunization/f:protocolApplied/f:targetDisease</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Immunization/f:protocolApplied/f:targetDisease/f:coding</sch:title>
