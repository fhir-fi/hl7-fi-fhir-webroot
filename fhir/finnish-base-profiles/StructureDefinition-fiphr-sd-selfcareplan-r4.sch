...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CarePlan">
      ...
      <sch:assert test="count(f:extension[@url = 'http://phr.kanta.fi/StructureDefinition/fiphr-ext-creatingapplication']) &lt;= 1">extension with URL = 'http://phr.kanta.fi/StructureDefinition/fiphr-ext-creatingapplication': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:author/f:identifier</sch:title>
    <sch:rule context="f:CarePlan/f:author/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:CarePlan/f:supportingInfo/f:identifier</sch:title>
    <sch:rule context="f:CarePlan/f:supportingInfo/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
