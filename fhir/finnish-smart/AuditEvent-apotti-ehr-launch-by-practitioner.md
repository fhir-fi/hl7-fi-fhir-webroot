# SMARTExampleApottiPractitionerEHR - Finnish Implementation Guide for SMART App Launch v2.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **SMARTExampleApottiPractitionerEHR**
...
Sensotrend's app has been set up in the [Epic on FHIR](https://fhir.epic.com/) portal and the Client ID has been downloaded to Apotti, and a launch button has been configured in Apotti.
...
The parameters `__epic.dstu2.patient`, `deptID`, and `loginDepartment` are Epic specific parameters, the rest are defined by the [SMART App Launch specification](http://www.hl7.org/fhir/smart-app-launch/).
...
The standard way to do this would be through the [`fhirContext`](http://www.hl7.org/fhir/smart-app-launch/scopes-and-launch-context.html#launch-context-arrives-with-your-access_token) parameter.
...
An alternative is to use the [token introspection](http://www.hl7.org/fhir/smart-app-launch/token-introspection.html) endpoint.

**type**: [DICOM 110114](http://hl7.org/fhir/R4/codesystem-dicom-dcim.html#dicom-dcim-110114): User Authentication

**subtype**: [DICOM 110120](http://hl7.org/fhir/R4/codesystem-dicom-dcim.html#dicom-dcim-110120): Application Start

**action**: Execute

**recorded**: 2023-01-24 12:20:18+0200

> **agent****who**: Apotti Ekosysteemi**requestor**: true

> **agent****who**: Sensotrend Oy**requestor**: false
...
| :--- | :--- | :--- |
| - | **Observer** | **Type** |
| * | Sensotrend Oy | [Audit Event Source Type 3](http://terminology.hl7.org/6.5.0/CodeSystem-security-source-type.html#security-source-type-3): Web Server |
...
<iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="null" src="https://www.youtube.com/embed/Nw15LDwtCaI?start=857" width="100%" frameborder="0" title="YouTube video player" height="100%"></iframe>
