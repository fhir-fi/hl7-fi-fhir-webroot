...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'CustomerJourneyId']) &lt;= 1">extension with URL = 'CustomerJourneyId': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'CustomerJourneyName']) &lt;= 1">extension with URL = 'CustomerJourneyName': maximum cardinality of 'extension' is 1</sch:assert>
